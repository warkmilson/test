...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 570384750, ; hash 0x21ff616e, from name: MyMauiApp
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 611682499, ; hash 0x247588c3, from name: aot-MyMauiApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MyMauiApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 61
	...
	%struct.DSOCacheEntry {
		i64 3164132718, ; hash 0xbc98d56e, from name: libaot-MyMauiApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MyMauiApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 365
	...
	%struct.DSOCacheEntry {
		i64 3641743190, ; hash 0xd9109756, from name: aot-MyMauiApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MyMauiApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 409
	...
	%struct.DSOCacheEntry {
		i64 3836991800, ; hash 0xe4b3d938, from name: libaot-MyMauiApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MyMauiApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 430
	...
	%struct.DSOCacheEntry {
		i64 4167000155, ; hash 0xf85f605b, from name: MyMauiApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MyMauiApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 469
